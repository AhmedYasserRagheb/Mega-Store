                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted font-weight-normal">
                                        <a href="{{url('showProducts')}}" class="btn btn-outline-light">Total Products</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted font-weight-normal">
                                        <a href="{{url('userOrders')}}" class="btn btn-outline-light">Total Orders</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted font-weight-normal">
                                        <a href="{{url('userOrders')}}" class="btn btn-outline-light">Total Customers</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted font-weight-normal">
                                        <a href="{{url('userOrders')}}" class="btn btn-outline-light">Total Processing</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted font-weight-normal">
                                        <a href="{{url('userOrders')}}" class="btn btn-outline-light">Total Deliverd</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="text-muted font-weight-normal">
                                        <button href="" class="btn btn-outline-light" disabled>Total Revenue</button>
                                    </h6>
